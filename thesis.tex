...
\newcommand{\thesistitle}{Karbala's Kaleidoscope: Rituals, Rumbles, and the Reshaping of Religious Authority}
...
\begin{center}
  ...
  \begin{doublespace}
    \textsc{
    Submitted to the Graduate School of Arts and Sciences in partial fulfillment of the requirements for the Master of Arts in Near Eastern Studies at New York University
    }
  \end{doublespace}
\end{center}
\vfill
...
\chapter{Liturgies and Salutes}
\label{chapter-1}

\input{chapter-1.tex}
\chapter{The Neighborhood Chanters}
\label{chapter-2}
